                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            <button id="notif-button" class="relative text-gray-600 hover:text-gray-800">
                                ...
                                <span id="notif-badge" class="hidden absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">0</span>
                            </button>
                            <div id="notif-menu" class="hidden absolute left-0 mt-2 w-80 bg-white rounded-lg shadow-lg py-2 z-50 max-h-96 overflow-y-auto"></div>
                        </div>
