...
if (empty($partnerId) || empty($partnerName) || empty($partnerPhone) || empty($sharePercentage) || empty($periodStart)) {
...
try {
    ...
    updateRecord('documents', $data, 'id = :id', ['id' => $partnerId]);
    
    logActivity('update', 'documents', $partnerId, "Updated partner: $partnerName");
